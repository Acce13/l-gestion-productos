                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" id="inputProduct" value="{{ old('name') }}" placeholder="Product">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="inputDescription" class="form-label text-secondary">Description <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="description" id="inputDescription" value="{{ old('description') }}" placeholder="Description">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="inputPrice" class="form-label text-secondary">Price <span class="text-danger">*</span></label>
                                <input type="number" min="0" class="form-control" name="price" id="inputPrice" value="{{ old('price') }}" placeholder="Price">
                            </div>
                        </div>
                        <div class="col-12">
