    ...
    <div class="row gy-4">
        ...
        <div class="col-12">
            <div class="bg-primary bg-gradient d-flex justify-content-between align-items-center py-2 px-3 rounded shadow">
                ...
                <div class="">
                    <a href="{{ route('users.create') }}" class="btn btn-primary btn-fab-lg border border-light fw-bolder rounded-circle">
                ...
                @if (count($users) > 0)
                    ...
                    <div class="col-lg-6 col-xl-6 col-xxl-4">
                        <div class="border border-primary-subtle py-3 px-3 rounded shadow-sm">
                            ...
                            <div class="d-flex">
                                <a href="{{ route('users.edit', $user) }}" class="btn btn-primary btn-fab-small border border-light fw-bolder rounded-circle">
