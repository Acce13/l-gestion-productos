                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" id="inputName" value="{{ old('name', $user->name) }}" placeholder="Name">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" min="0" class="form-control" name="address" id="inputAddress" value="{{ old('address', $user->address) }}" placeholder="Address">
                            </div>
                        </div>
                        <div class="col-12">
